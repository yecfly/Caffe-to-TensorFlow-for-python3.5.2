...
class TensorFlowNode(object):
    ...
    def format(self, arg):
        ...
        #return "'%s'" % arg if isinstance(arg, basestring) else str(arg) #basestring is defined in python 2.x not in python 3.x
    ...
    def emit(self):
        ...
        #args = map(self.format, self.args) #works OK in python 2.x but not OK in python 3.x
...
class TensorFlowTransformer(object):
    ...
    def load(self, def_path, data_path, phase):
        ...
        if data_path is not None:
            ...
            self.verbose = False #avoid unexpected failure in displaying graph
        ...
        transformers = [
            ...
            #                                NodeKind.BatchNorm]),
            ReLUFuser(allowed_parent_types=[NodeKind.CONVOLUTION, NodeKind.INNER_PRODUCT,
                                            NodeKind.BATCH_NORM,NodeKind.Convolution, NodeKind.InnerProduct,
                                            NodeKind.BatchNorm]),
